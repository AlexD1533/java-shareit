...
public class RequestItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> createRequest(long userId, NewRequestItem requestDto) {
    ...
    public ResponseEntity<Object> getAllRequests(long ownerId) {  // Добавлен параметр ownerId
